...
const TeamplateSelector = ({ selectedTemplate, onChange }) => {
          ...
          {templates.map((e) => (
            ...
            >
              ...
              <div className="space-y-1">
                <h4 className="font-medium text-gray-800">{e.name}</h4>
...
export default TeamplateSelector;