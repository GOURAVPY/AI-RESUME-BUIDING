...
const Footre = () => {
  return (
    <div className="  mt-[120px]">
      <footer className=" bg-gradient-to-r from-white via-green-200/60 to-white flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
        <div className="flex items-center gap-8">
          <a
            href="#"
            className="font-medium text-gray-500 hover:text-green-400 transition-all"
          >
            Home
          </a>
          <a
        ...
        <p className="mt-8 text-center">
          Copyright © 2025 <a className=" text-green-400" href="https://prebuiltui.com"> Resume. </a> All
          rights reservered.
        </p>
      </footer>
    </div>
